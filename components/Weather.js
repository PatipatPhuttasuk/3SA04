    ...
    render() {
        return (
            <View style={styles.container}>
                <ImageBackground source={require("../bt.jpg")} style={styles.backdrop}>
                    ...
                    <Text style={styles.black}> </Text>
                    <Text style={styles.black}>                 By Patipat Phuttasuk</Text>
                    <Text style={styles.black}>                  ID :   5835512104</Text>
                </ImageBackground>
            </View>
        );
    }
